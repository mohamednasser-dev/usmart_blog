...
يوسمارت افضل شركة برمجة تطبيقات الموبايل بالكويت
     ...
     <div class="container">
       ...
       <section class="row">
        ...
        <a href="/blog/category/{{$category->url}}" class="col-md-3 col-sm-6 pt-4 wow fadeInUp">
          <div class="col-12 p-5 cat-box" style="background-image:url('https://res.cloudinary.com/dqthprijd/image/upload/w_300,h_250,c_crop,q_100/v1586068288/{{$category->image}}');">
            <div class="p-2 t-white cat-box-content">
              <h3>{{ $category->title_ar }}</h3>
            </div>
          </div>
         </a>
        @endforeach
       ...
       <section class="row pt-5 category_row">
        <div class="col-md-12">
          <h4 class="float-left pt-1 wow fadeInRight">مقالات عن {{$category->title_ar}}</h4>
          <a href="/blog/category/{{$category->url}}" class="btn btn-outline-dark float-right wow fadeInLeft"> عرض الجميع</a>
        </div>
    ...
    <script>
      ...
      var elements = $(".category_row");
      var count = elements.length;
      var first_add_position = Math.floor(count / 2) - 1
      var last_add_position = count - 2
      var ads = <?=$data['ads']?>;
      
      

      // append ads
      $("<a href='"+ads[0]['content']+"' target='_blank' class='row pt-5'><img src='https://res.cloudinary.com/dqthprijd/image/upload/w_1920,h_250,c_fill,q_100/v1586068288/"+ads[0]['image']+"' alt='' class='img-fluid'></a>").insertAfter(".category_row:eq("+first_add_position+")");
      $("<section class='row pt-5 mt-3 p-0'><a href='"+ads[1]['content']+"' class='col-md-6 p-2'><img src='https://res.cloudinary.com/dqthprijd/image/upload/w_900,h_250,c_fill,q_100/v1586068288/"+ads[1]['image']+"' alt='' class='img-fluid'></a><a href='"+ads[2]['content']+"' class='col-md-6 p-2'><img src='https://res.cloudinary.com/dqthprijd/image/upload/w_900,h_250,c_fill,q_100/v1586068288/"+ads[2]['image']+"' alt='' class='img-fluid'></a></section>").insertAfter(".category_row:eq("+last_add_position+")");
